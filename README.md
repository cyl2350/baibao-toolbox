...
一个**免费在线工具集**静态网站,包含 54 款纯前端小工具(二维码生成与解码、图片压缩、房贷计算、折扣计算、恋爱天数、文本加密、银行卡校验、VIN 车架号校验、ISBN 校验、手机号校验、条形码生成、Emoji 大全、番茄钟、卡路里计算、身份证校验、日期计算、人民币大写、BMI、JSON 格式化、时间戳转换、Base64、Markdown 编辑器等),所有工具在浏览器本地运行,不上传任何数据。
